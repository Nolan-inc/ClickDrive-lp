      ...
      <div className="relative z-10 container mx-auto px-4 md:px-12 lg:px-[100px] overflow-x-hidden w-full max-w-full">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            私たちの<span className="text-blue-500">作品</span>
          </h2>
        ...
        <div className="text-center mt-16">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-8 py-4 rounded-full font-semibold text-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            無料相談を始める
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
