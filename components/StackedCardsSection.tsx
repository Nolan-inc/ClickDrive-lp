      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <div className="inline-block mb-4">
            <span className="text-sm md:text-base lg:text-lg font-semibold tracking-wider uppercase" style={{ color: themeColor }}>
              FEATURES
            </span>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {/* Point 1 */}
          <div className="bg-gray-50 rounded-2xl p-6 md:p-8 hover:shadow-lg transition-all duration-300">
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl flex items-center justify-center mb-6" style={{ backgroundColor: `${themeColor}20` }}>
              <svg className="w-8 h-8 md:w-10 md:h-10" style={{ color: themeColor }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>

            <div className="text-sm md:text-base font-semibold mb-3" style={{ color: themeColor }}>Point 1</div>
          ...
          <div className="bg-gray-50 rounded-2xl p-6 md:p-8 hover:shadow-lg transition-all duration-300">
            ...
            <div className="text-sm md:text-base font-semibold mb-3" style={{ color: themeColor }}>Point 2</div>
          ...
          <div className="bg-gray-50 rounded-2xl p-6 md:p-8 hover:shadow-lg transition-all duration-300">
            ...
            <div className="text-sm md:text-base font-semibold mb-3" style={{ color: themeColor }}>Point 3</div>
